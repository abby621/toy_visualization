...
test_file = './val.txt'
pretrained_net = './output/ckpts/checkpoint-201801261523_lr0pt0001_outputSz128_margin0pt3-658'
...
for step in range(0,num_iters):
    ...
    ff,vv,mm = sess.run([feat,varvar,meanmean], feed_dict={image_batch: batch, label_batch:[il[1]]})
    print vv
    testingFeats[step,:] = ff
